...
/* Define if gmime should be used in sipe. */
/* #undef HAVE_GMIME */
...
/* Define if nss should be used in sipe. */
/* #undef HAVE_NSS */
...
/* Define if voice & video is enabled. */
#define HAVE_VV 1
...
/* Define if libnice is compatible with Office Communicator */
#define NICE_HAS_COMPATIBILITY 1
...
#define PACKAGE_STRING "pidgin-sipe 1.11.0"
